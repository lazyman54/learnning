 ...
 * @date 2017/11/13
 */
public class IdKeyGeneratorWithShotDateForLong extends AbstractedIdKeyGeneratorWithDate implements INumIdKeyGenerator {

    private static final byte DATE_BITS = 20;

    public IdKeyGeneratorWithShotDateForLong(byte workerIdBits, byte sequenceBits) {
